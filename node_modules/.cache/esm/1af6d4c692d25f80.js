let db,Helper,adminQueries,super_queries;_92d‍.x([["default",()=>SuperService]]);_92d‍.w("../config/config",[["default",["db"],function(v){db=v}]]);_92d‍.w("../utils/helpers/helpers",[["default",["Helper"],function(v){Helper=v}]]);_92d‍.w("../queries/admin.queries",[["default",["adminQueries"],function(v){adminQueries=v}]]);_92d‍.w("../queries/super.queries",[["default",["super_queries"],function(v){super_queries=v}]]);




const { fetchResourceByPage } = Helper;
const {
  findSuperByEmail,
  fetchAllUsers,
  createAdmin,
