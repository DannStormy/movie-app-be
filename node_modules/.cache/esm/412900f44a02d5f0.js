let db,bcrypt,jwt;_4a0‍.x([["default",()=>Helper]]);_4a0‍.w("../../config/config",[["default",["db"],function(v){db=v}]]);_4a0‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_4a0‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
  ...
  static async comparePasswordHash(password, hash) {
    ...
    _4a0‍.g.console.log("Result", hash);
    return result;
  }
  /**
   * generate user token
