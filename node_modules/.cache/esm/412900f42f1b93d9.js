let db,bcrypt,jwt;_2f1‍.x([["default",()=>Helper]]);_2f1‍.w("../../config/config",[["default",["db"],function(v){db=v}]]);_2f1‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_2f1‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
  ...
  static async comparePasswordHash(password, hash) {
    ...
    _2f1‍.g.console.log("Result", hash);
    return result;
  }
