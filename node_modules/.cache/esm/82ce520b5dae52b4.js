let MovieService;_5da‍.x([["fetchMovies",()=>fetchMovies],["fetchMovieByID",()=>fetchMovieByID],["updateMovieRating",()=>updateMovieRating],["addNewMovie",()=>addNewMovie],["deleteMovie",()=>deleteMovie]]);_5da‍.w("../services/movie.service",[["default",["MovieService"],function(v){MovieService=v}]]);
...
const fetchMovies = async (req, res) => {
  try {
    _5da‍.g.console.log("All queries", req.query);
    ...
    _5da‍.g.console.log(error); //will use logger instead (testing now)
    return error;
  }
};
