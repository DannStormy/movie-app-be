let db,bcrypt,jwt,adminQueries,userQueries;_66b‍.x([["default",()=>Helper]]);_66b‍.w("../../config/config",[["default",["db"],function(v){db=v}]]);_66b‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_66b‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_66b‍.w("../../queries/admin.queries",[["default",["adminQueries"],function(v){adminQueries=v}]]);_66b‍.w("../../queries/user.queries",[["default",["userQueries"],function(v){userQueries=v}]]);
  ...
  static async isActive(userId, role) {
    try {
      ...
      if (role === "admin") {
        ...
        _66b‍.g.console.log("status", userId, role);
        return status;
      }
    } catch (error) {
      logger.error(error);
