let db,bcrypt,jwt;_40c‍.x([["default",()=>Helper]]);_40c‍.w("../../config/config",[["default",["db"],function(v){db=v}]]);_40c‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_40c‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
/**
  ...
  static async comparePasswordHash(password, hash) {
    ...
    _40c‍.g.console.log('Result', hash)
    return result;
  }
/**
   * generate user token
